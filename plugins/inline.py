...
buttons = [
            [
                InlineKeyboardButton("CHANNEL", url="https://t.me/ghanalatestsongs"),
                InlineKeyboardButton("SUPPORT", url="https://t.me/livefootballapp"),
            ],
            [
    ...
    if query.query == "SAF_ONE":
        answers.append(
            InlineQueryResultArticle(
                ...
                input_message_content=InputTextMessageContent(f"{REPLY_MESSAGE}\n\n<b>© Powered By : \n@ghanalatestsongs | @livefootballapp 👑</b>", disable_web_page_preview=True),
